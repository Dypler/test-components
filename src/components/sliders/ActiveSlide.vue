...
<template>
  <div
    class="relative flex flex-col gap-4 bg-no-repeat bg-center bg-cover w-[580px] h-[429px] justify-end"
  ...
  >
    ...
    <div class="flex flex-col gap-4 max-w-[468px] p-8">
      <p
        class="border border-white font-bebas text-xl flex text-white justify-center max-w-[109px]"
      >
        {{ slide.data }}
      </p>
      <p class="font-bebas text-white font-bold text-3xl">
        {{ slide.content }}
      </p>
    </div>
  </div>
