...
<template>
  <div class="relative pt-20">
    ...
    >
      <swiper-slide>
        <div
          class="relative flex flex-col gap-4 bg-no-repeat bg-center bg-cover w-[580px] h-[640px] justify-end bg-[url('/main/courses1.png')]"
        >
          ...
          <div class="flex flex-col gap-4 p-8">
            ...
            <p class="font-bebas text-white font-bold text-4xl">
      ...
      <swiper-slide>
        <div
          class="relative flex flex-col gap-4 bg-no-repeat bg-center bg-cover w-[580px] h-[299px] justify-end bg-[url('/main/courses2.png')]"
        >
          <a href="" class="cursor-pointer">
            <svg
              class="absolute right-3 top-3 z-10"
      ...
      <swiper-slide>
        <div
          class="relative flex flex-col gap-4 bg-no-repeat bg-center bg-cover w-[580px] h-[299px] justify-end bg-[url('/main/courses3.png')]"
        >
          <a href="" class="cursor-pointer">
            <svg
              class="absolute right-3 top-3 z-10"
